// // fisrt generate a number 

// function GuessTheNumber (){
//     let selectedNumber =Math.floor(Math.random()*10)+1;
//     console.log(selectedNumber)
//     let count =0 ;
//     const userPropmtValue = prompt("Guess the Number?");
//     if(parseInt(userPropmtValue)===selectedNumber)
//     {   
//         count++
//         console.log("Yeh you are win",count )
      
//     }else if(parseInt(userPropmtValue)>selectedNumber){
//         count++
//         console.log("Too High" ,count)
//     }else if(parseInt(userPropmtValue)<selectedNumber){
//         count++
//         console.log("Too Low" ,count)
//     }else{
//         count++
//         console.log("Invalid Value",count);
//     }
