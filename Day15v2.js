...
const arraywithArrayConstructor = new Array(4,6,8,9,8,);
// console.log(arraywithArrayConstructor);
//  T-002: Create an array of 3 empty slots.
const emptyArray = new Array(3);
// console.log(emptyArray)
//  T-003: Create an array of 6 elements using the Array literals and access the fourth element in the array using its length property.
const arrayLiteral = [4,7,8,9,10,66];
//  T-004: Use the for loop on the above array to print elements in the odd index.
for(let i = 0; i<arrayLiteral.length; i++)
{
    if(arrayLiteral[i]%2 ===0){
        // console.log(arrayLiteral[i]);
    }
};
//  T-005: Add one element at the front and the end of an array.
arrayLiteral.unshift(50);
//  T-006: Remove an element from the front and the end of an array.
arrayLiteral.shift()
// console.log(arrayLiteral);
//  T-007: Create an array containing the name of your favourite foods(10 foods). Destructure the 6th food element from the array using destructuring.
const foodName =["Apple","Mango","IceCreame","Falooda","Aromatic","Birany","Ramnen","Noodles","Beef","Chillie Curry"]
